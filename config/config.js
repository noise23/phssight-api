...
var home = process.env.INSIGHT_DB || ('/work/www/explorer.phstones.com/phssight/.db');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Philosopherstone\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Philosopherstone/';
  if (isLinux) dataDir = process.env.HOME + '/.Philosopherstone/';
}
...
var bitcoindConf = {
  ...
  user: process.env.BITCOIND_USER || 'phsrpc',
