...
var encodedData = require('soop').load('phscore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('phscore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('phscore/lib/Address', {
