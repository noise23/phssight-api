...
var encodedData = require('soop').load('core/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('core/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('core/lib/Address', {
